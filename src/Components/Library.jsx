...
export default function Library() {
  ...
  return (
    <div
      className={`pb-56 sm:pb-40 px-4 sm:px-6 pt-6 min-h-screen relative transition-colors duration-500`}
      style={{
        fontSize: `${fontSize}px`,
        backgroundColor: darkMode ? "#111827" : "#f3f4f6",
        color: darkMode ? "white" : "black",
    ...
    >
      <div className="relative z-10">
        ...
        {nowPlaying && (
          ...
          >
            <div className="max-w-screen-xl mx-auto px-3 py-3 flex flex-col gap-3">

              {/* Row 1: artwork + song info + close */}
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-sm sm:text-base font-semibold truncate">{nowPlaying.trackName}</h4>
                ...
                <button
                  ...
                  className={`flex-shrink-0 text-lg px-2 py-1 rounded-md transition ${
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  onClick={() => saveToStorage("likedSongs", nowPlaying, setLiked)}
                  className={`flex-1 min-w-[80px] text-xs sm:text-sm px-3 py-1.5 rounded-md border transition ${
                    isLiked(nowPlaying.trackId)
                      ? "bg-green-100 text-green-600 border-green-300"
                      : darkMode
                      ? "border-gray-600 hover:bg-gray-700 text-white"
                ...
                <button
                  ...
                  className="flex-1 min-w-[80px] text-xs sm:text-sm px-3 py-1.5 rounded-md border border-blue-400 text-blue-500 hover:bg-blue-100 transition"
                >
                  ➕ Playlist
                </button>
              </div>
        ...
        {showPlaylistModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
            <div className={`p-6 rounded-lg w-full max-w-sm transition-colors duration-500 ${darkMode ? "bg-gray-800 text-white" : "bg-white text-black"}`}>
              <h3 className="text-lg font-semibold mb-4">Add to Playlist</h3>
              <input
                type="text"
                value={playlistName}
