...
export default function Home() {
  return (
    <div className="min-h-screen py-16 px-4 flex flex-col items-center bg-gradient-to-br from-[#121212] to-[#1f1f1f] text-white font-sans">
      ...
      <div className="w-full max-w-5xl flex flex-col gap-8">
        ...
        <Link to="/feed" className="w-full no-underline">
          <div className="flex items-center bg-[#1e1e1e] rounded-2xl overflow-hidden shadow-md hover:shadow-pink-500/30 hover:-translate-y-1 transition duration-300 p-4">
            <img
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-300">Discover new tracks and playlists</p>
            </div>
          </div>
        </Link>
        ...
        <Link to="/trending" className="w-full no-underline">
          <div className="flex items-center bg-[#1e1e1e] rounded-2xl overflow-hidden shadow-md hover:shadow-pink-500/30 hover:-translate-y-1 transition duration-300 p-4">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-300">Check out the latest trending music</p>
            </div>
          </div>
        </Link>
        ...
        <Link to="/favorites" className="w-full no-underline">
          <div className="flex items-center bg-[#1e1e1e] rounded-2xl overflow-hidden shadow-md hover:shadow-pink-500/30 hover:-translate-y-1 transition duration-300 p-4">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-300">Your favorite tracks and playlists</p>
            </div>
          </div>
        </Link>
        ...
        <Link to="/liked-songs" className="w-full no-underline">
          <div className="flex items-center bg-[#1e1e1e] rounded-2xl overflow-hidden shadow-md hover:shadow-pink-500/30 hover:-translate-y-1 transition duration-300 p-4">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-300">The Songs you Liked!</p>
            </div>
          </div>
        </Link>
