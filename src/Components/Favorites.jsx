...
//       <h1 className="text-4xl font-bold text-pink-400 mb-8 text-center">Your Favorites</h1>
...
//         ) : (
//           favorites.map((song) => (
//             <div key={song.trackId} className="bg-[#1e1e1e] rounded-xl p-4 flex flex-col items-center shadow-md hover:shadow-pink-500/30 transition">
//               <img
